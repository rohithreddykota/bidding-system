...
BEGIN
  ...
  -- Insert the new user
  INSERT INTO [User]
    (User_FirstName, User_LastName, UserEmail, UserPassword, Gender, DateofBirth, UserType, User_FullName, Age)
  VALUES
    (@FirstName, @LastName, @UserEmail, @UserPassword, @Gender, @DateOfBirth, @UserType, [dbo].GetFullName(@FirstName, @LastName), [dbo].CalculateAge(@DateOfBirth));
...
BEGIN
  SET NOCOUNT ON;
  INSERT INTO AdItem
    (AdminID, CategoryID, SellerID, AdStatusID, Title, AdDescription)
  VALUES
    (@AdminID, @CategoryID, @SellerID, @AdStatusID, @Title, @AdDescription);
END;
